...
export default function LunaJournal() {
    ...
    const save = () => {
        ...
        const entry = {
            ...
            phase: user.currentPhase, phaseLabel: p.label,
                ...
                {view === 'write' && (
                    <div className="anim-fade-up">
                        ...
                        <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 10 }}>
                            <div className="phase-pill" style={{ background: p.bg, color: p.color, border: `1px solid ${p.color}44` }}>{p.emoji} {p.label} · Day {user.currentDay}</div>
                ...
                {view === 'history' && (
                    <div className="anim-fade-up">
                        <div style={{ marginBottom: 16 }}>
                            <Heatmap entries={entries} phase={user.currentPhase} phaseColor={p.color} />
                        </div>
