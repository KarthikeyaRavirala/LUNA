...
export default function Dashboard() {
    ...
    const w = WELLNESS_SNIPPETS[user.currentPhase] || WELLNESS_SNIPPETS.luteal;
                ...
                <div style={{ background: p.bg, border: `1px solid ${p.color}44`, borderRadius: 'var(--r-xl)', padding: 20, marginBottom: 14 }} className="anim-fade-up">
                    <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start', marginBottom: 14 }}>
                        ...
                        <div style={{ flex: 1 }}>
                            ...
                            <div style={{ fontSize: 12, color: 'var(--text-dim)' }}>Day {user.currentDay} · {WELLNESS_SNIPPETS[user.currentPhase]?.confidence?.split('.')[0] || 'Keep going'}</div>
                        </div>
                        <div style={{ textAlign: 'right', flexShrink: 0 }}>
                            <div className="serif" style={{ fontSize: 28, color: p.color, fontWeight: 700, lineHeight: 1 }}>Day {user.currentDay}</div>
