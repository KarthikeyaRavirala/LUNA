...
export default function CravingKitchen() {
    ...
    const [activePhase, setActivePhase] = useState(user.currentPhase || 'luteal');
                ...
                {view === 'recipes' && (
                    <div className="anim-fade-up">
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                            ...
                            {activePhase === user.currentPhase && <div style={{ fontSize: 11, color: ph.color, fontWeight: 700 }}>← Your current phase</div>}
                        </div>
