...
export default function AuthPage() {
    ...
    const { login, signUpWithGoogle } = useApp();
    ...
    const handleLogin = async (e) => {
        ...
        login({ email, name: email.split('@')[0], lunaName: email.split('@')[0].replace(/[^a-zA-Z]/g, '') || 'LunaUser' });
        setLoading(false);
        navigate('/dashboard');
    };
        ...
        <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-sans)', padding: 20 }}>
            <div style={{ width: '100%', maxWidth: 420 }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 28 }}>
                    <div className="serif" style={{ fontSize: 36, fontWeight: 700, color: 'var(--rose-lite)', marginBottom: 6 }}>🌸 LUNA</div>
