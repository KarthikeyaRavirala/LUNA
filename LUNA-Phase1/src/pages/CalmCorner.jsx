...
export default function CalmCorner() {
    ...
    const affirmations = AFFIRMATIONS[currentPhase] || AFFIRMATIONS.luteal;
    const meditations = MEDITATIONS[currentPhase] || MEDITATIONS.luteal;
    const playlists = PLAYLISTS[currentPhase] || PLAYLISTS.luteal;
